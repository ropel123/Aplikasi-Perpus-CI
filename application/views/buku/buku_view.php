                                        ...
                                        <tr>
                                            ...
                                            <td <?php if ($this->session->userdata('level') == 'Petugas') { ?>style="width:17%;" <?php } ?>>
                                                ...
                                                <?php if ($this->session->userdata('level') == 'Petugas') { ?>
                                                    ...
                                                    $kbuku = $isi['buku_id'];
                                                    $sta = 'Dipinjam';
                                                    $pok = $this->db->query("SELECT * FROM tbl_buku WHERE buku_id='$kbuku'")->row();
                                                    if (
                                                        $pok->jml
                                                        > 0
                                                    ) {
                                                        $pul = $this->db->get_where('tbl_pinjam', ['buku_id' => $kbuku, 'anggota_id' => $id, 'status' => $sta])->num_rows();
                                                        if ($pul > 0) {

                                                    ?>
                                                            <i class="fa fa-check" style="margin-right:0; margin-top:10px;">
                                                                Masih Meminjam
                                                            </i>
                                                            <a href="<?= base_url('data/bukudetail/' . $isi['id_buku']); ?>">
                                                                <button class="btn btn-primary"><i class="fa fa-sign-in"></i> Detail</button></a>
                                                        <?php  } else {
                                                            ...
                                                            $uss = $this->session->userdata('anggota_id');
                                                        ?>

                                                            <a href="<?= base_url('transaksi/pinjammember/' . $isi['id_buku'] . '/' . $uss); ?>">
                                                                <button class="btn btn-primary"><i class="fa fa-sign-in"></i> Pinjam Buku</button></a>
                                                            <a href="<?= base_url('data/bukudetail/' . $isi['id_buku']); ?>">
                                                                <button class="btn btn-primary"><i class="fa fa-sign-in"></i> Detail</button></a>
                                                        ...
                                                        ?>
                                                            ...
                                                            <i class="fa fa-ban" style="margin-right:0; margin-top:10px;">
                                                                Stok Habis
                                                            </i>
                                                            <a href="<?= base_url('data/bukudetail/' . $isi['id_buku']); ?>">
                                                                <button class="btn btn-primary"><i class="fa fa-sign-in"></i> Detail</button></a>
