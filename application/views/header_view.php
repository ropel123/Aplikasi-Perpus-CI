...
<head>
  ...
  <title><?php echo $title_web; ?> | Sistem Informasi Perpustakaan Recode Kelompok3</title>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets_style/assets/dist/css/animate.min.css">
  ...
  <div class="wrapper">
    <header class="main-header">
      ...
      <a href="<?php echo base_url('index.php/dashboard'); ?>" class="logo">
        ...
        <span class="logo-lg">Perpus GoLearn</span>
      </a>
      ...
      <nav class="navbar navbar-static-top">
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li>
              <a class="logout" id="logout" href="<?php echo base_url(); ?>login/logout">Sign out</a>
            </li>
