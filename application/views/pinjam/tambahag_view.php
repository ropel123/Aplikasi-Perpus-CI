                                ...
                                <div class="col-sm-5">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <?php $pol = $this->session->userdata('anggota_id');
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <input type="text" class="form-control" required autocomplete="off" readonly name="anggota_id" id="search-box" type="text" value="<?= $pol ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <?php
                                                    if ($this->session->userdata('pp') != '') {
                                                        $pul = $this->session->userdata('pp');
                                                        $kode = $this->db->query("SELECT * FROM tbl_buku WHERE id_buku='$pul'")->row();
                                                        $this->session->set_userdata('pp', '');
                                                    }
                                                    ?>
                                                    <input type="text" class="form-control" required autocomplete="off" readonly name="buku_id" id="buku_idd" type="text" value="<?= $kode->buku_id; ?>" data-status="<?= $this->session->userdata('pp'); ?>">
...
<script>
    // AJAX call for autocomplete  Kode Anggota
    $(document).ready(function() {
        var pol = document.getElementById('search-box').value;
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('transaksi/result'); ?>",
            data: 'kode_anggota=' + pol,
            beforeSend: function() {
                $("#result").html("");
